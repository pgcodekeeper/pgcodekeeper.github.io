...
!function(){!function(e,t,n,a,c,o,s){e.GoogleAnalyticsObject=c,e[c]=e[c]||function(){(e[c].q=e[c].q||[]).push(arguments)},e[c].l=1*new Date,o=t.createElement(n),s=t.getElementsByTagName(n)[0],o.async=1,o.src=a,s.parentNode.insertBefore(o,s)}(window,document,"script","https://www.google-analytics.com/analytics.js","ga"),ga("create","UA-77897743-1","auto"),ga("send","pageview")}();
...
!function(){function o(){$("[data-toggle=popover]").popover({trigger:"click",delay:{show:500,hide:100}});var o=function(){$("body").on("click",function(o){"popover"!==$(o.target).data("toggle")&&0===$(o.target).parents(".popover.in").length&&$('[data-toggle="popover"]').popover("hide")})};o()}function n(o){var n="Скопировано!",e="Copied!",t="en"===o?e:n;$(document).on("click","#popoverbutton",function(){var o=document.querySelector(".js-emaillink");window.getSelection().removeAllRanges();var n=document.createRange();n.selectNode(o),window.getSelection().addRange(n);try{var e=document.execCommand("copy"),l=e?"successful":"unsuccessful";console.log("Copy email command was "+l),$("#popoverbutton").attr("title",t)}catch(c){console.log("Oops, unable to copy"),$("#popoverbutton").attr("title","Ctrl+C")}window.getSelection().removeAllRanges()})}function e(){$(document).click(function(o){window.innerWidth<=992&&jQuery(".navbar-collapse").hasClass("collapse in")&&$(".collapse").collapse("hide")})}function t(){var o=/iphone|ipod|android|blackberry|mini|windows\sce|palm/i.test(navigator.userAgent.toLowerCase());o?($("#ToTop").css("display","none"),$("#OnBottom").css("display","none")):$(function(){$(window).scrollTop()>="250"&&$("#ToTop").fadeIn("slow"),$(window).scroll(function(){$(window).scrollTop()<="250"?$("#ToTop").fadeOut("slow"):$("#ToTop").fadeIn("slow")}),$(window).scrollTop()<=$(document).height()-"999"&&$("#OnBottom").fadeIn("slow"),$(window).scroll(function(){$(window).scrollTop()>=$(document).height()-"999"?$("#OnBottom").fadeOut("slow"):$("#OnBottom").fadeIn("slow")}),$("#ToTop").click(function(){$("html,body").animate({scrollTop:0},"slow")}),$("#OnBottom").click(function(){$("html,body").animate({scrollTop:$(document).height()},"slow")})})}$(document).ready(function(){var l=document.documentElement.lang;o(),n(l),e(),t()})}();